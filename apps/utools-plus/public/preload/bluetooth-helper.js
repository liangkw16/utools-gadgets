...
async function openBluetoothSettings () {
  assertMacOS()
  const { command, args } = getBluetoothSettingsInvocation()
  await execFileAsync(command, args)
  return buildActionEnvelope('open-settings', null)
}
...
function getBluetoothSettingsInvocation () {
  return {
    command: OPEN,
...
module.exports = {
  ...
  getBluetoothSettingsInvocation,
